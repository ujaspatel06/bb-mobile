...
class CommonLinerProgressBar extends StatefulWidget {
  ...
  @override
  _CommonLinerProgressBarState createState() => _CommonLinerProgressBarState();
}

class _CommonLinerProgressBarState extends State<CommonLinerProgressBar>
  ...
  @override
  void didUpdateWidget(CommonLinerProgressBar old) {
    triggerAnimation();
...
class AnimatedProgressBar extends AnimatedWidget {
  ...
  final CommonLinerProgressBar widget;
